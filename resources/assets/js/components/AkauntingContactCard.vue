        ...
        <div class="document-contact" :class="[{'fs-exclude': show.contact_selected}]">
            <div class="document-contact-without-contact">
                <div v-if="!show.contact_selected"
                     class="document-contact-without-contact-box-contact-select fs-exclude">
                    <div class="aka-select aka-select--medium is-open" tabindex="0">
                                ...
                                <div class="aka-box-content">
                                    <div class="document-contact-without-contact-box">
                                        <button type="button"
                                            ...
                                            class="text-add-contact"> {{ addContactText }} </span>
                                        </button>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="aka-select-menu" v-if="show.contact_list">
                            ...
                            <ul class="aka-select-menu-options">
                                <div class="aka-select-menu-option" v-for="(contact, index) in sortContacts"
                                     :key="index" @click="onContactSeleted(index, contact.id)">
                                    <div>
                                ...
                                <div class="aka-select-menu-option" v-if="!sortContacts.length">
                                    <div>
                                        <strong class="text-strong" v-if="!contacts.length && !search"><span>{{
                                                noDataText
                                            }}</span></strong>

                                        <strong class="text-strong" v-else><span>{{
                                                noMatchingDataText
                                            }}</span></strong>
                                    </div>
                                </div>
