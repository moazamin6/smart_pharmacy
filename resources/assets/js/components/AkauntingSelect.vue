<template>
    <base-input :label="title" :name="name"
        ...
        >
            ...
            <div v-if="addNew.status && options.length != 0 && sortedOptions.length == 0"
            ...
            <el-option v-if="!loading && addNew.status && options.length != 0 && sortedOptions.length > 0"
                       class="el-select__footer select-add-new" disabled value="">
                <div @click="onAddItem">
                    <i class="fas fa-plus"></i>
                    <span>
                        {{ addNew.text }}
