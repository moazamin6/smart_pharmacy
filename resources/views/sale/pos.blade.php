                        ...
                        <div class="payment-options">
                            ...
                            <div class="column-5">
                                <button style="background-color: #213170" type="button"
                                        ...
                                        data-target="#add-payment" id="paypal-btn"><i
                            ...
                            <div class="column-5">
                                <button style="background-color: #fd7272" type="button"
                                        class="btn btn-custom payment-btn" data-toggle="modal"
                                        data-target="#add-payment" id="cheque-btn"><i
                            ...
                            <div class="column-5">
                                <button style="background-color: #b33771" type="button"
                                        class="btn btn-custom payment-btn" data-toggle="modal"
                                        data-target="#add-payment" id="deposit-btn"><i
                                    ...
                                    <div class="navbar-header">
                                        ...
                                        <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                                            <li class="nav-item"><a id="btnFullscreen" data-toggle="tooltip"
                                                                    title="Full Screen"><i class="dripicons-expand"></i></a>
                                            </li>
                                            <?php
                                            $general_setting_permission = DB::table('permissions')->where('name', 'general_setting')->first();
                                            $general_setting_permission_active = DB::table('role_has_permissions')->where([
                                            ...
                                            <li class="nav-item">
                                                <a class="dropdown-item" data-toggle="tooltip"
                                                   title="{{trans('file.Help')}}" href="{{ url('public/read_me') }}"
                                                   target="_blank"><i class="dripicons-information"></i></a>
                                            </li>&nbsp;
                                            <li class="nav-item">
