        ...
        <div class="col-xl-3">
            ...
            <ul class="list-group mb-4">
                ...
                <li class="list-group-item border-0 border-top-1">
                    ...
                    <div><small class="long-texts" title="{{ $vendor->tax_number }}">{{ $vendor->tax_number }}</small>
                    </div>
                </li>
                ...
                @if ($vendor->reference)
                    ...
                    <li class="list-group-item border-0 border-top-1">
                        ...
                        <div><small class="long-texts" title="{{ $vendor->reference }}">{{ $vendor->reference }}</small>
                        </div>
                    </li>
                ...
                <div class="col-md-12">
                    <div class="nav-wrapper">
                        <ul class="nav nav-pills nav-fill flex-column flex-md-row" id="tabs-icons-text" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link mb-sm-3 mb-md-0 active" id="bills-tab" data-toggle="tab"
                                   href="#bills-content" role="tab" aria-controls="bills-content"
                                   aria-selected="false">{{ trans_choice('general.bills', 2) }}</a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a class="nav-link mb-sm-3 mb-md-0" id="transactions-tab" data-toggle="tab"
                                   ...
                                   aria-selected="true">{{ trans_choice('general.transactions', 2) }}</a>
                            </li>
                    ...
                    <div class="card">
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade show active" id="bills-content" role="tabpanel"
                                        ...
                                        @foreach($bills as $item)
                                            <tr class="row align-items-center border-top-1 tr-py">
                                                <td class="col-xs-4 col-sm-1"><a
                                                        href="{{ route('bills.show', $item->id) }}">{{ $item->document_number }}</a>
                                                </td>
                                        ...
                                        @foreach($transactions as $item)
                                            <tr class="row align-items-center border-top-1 tr-py">
                                                <td class="col-xs-6 col-sm-2"><a
                                                        href="{{ route('payments.show', $item->id) }}">@date($item->paid_at)</a>
                                                </td>
