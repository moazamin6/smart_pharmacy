<div class="accordion" id="notification-recurring-{{$type}}">
    <div class="card">
        <div class="card-header" id="heading-recurring-{{$type}}" data-toggle="collapse"
             data-target="#collapse-recurring-{{$type}}"
        ...
        <div id="collapse-recurring-{{$type}}" class="collapse" aria-labelledby="heading-recurring-{{$type}}"
             data-parent="#notification-recurring-{{$type}}">
            @if ($notifications->total())
                            ...
                            <tr class="row align-items-center border-top-1">
                                ...
                                @if (!$hideDocumentNumber)
                                    <td class="{{ $classDocumentNumber }}">
                                        ...
                                        <a href="{{ route($routeButtonShow , $item->id) }}"
                                           target="_blank">{{ $item->document_number }}</a>
                                ...
                                @if (!$hideStatus)
                                    <td class="{{ $classStatus }}">
                                        ...
                                        <span
                                            class="badge badge-pill badge-{{ $item->status_label }}">{{ trans($textDocumentStatus . $item->status) }}</span>
