<div class="accordion" id="notification-reminder-{{$type}}">
    <div class="card">
        <div class="card-header" id="heading-reminder-{{$type}}" data-toggle="collapse"
             data-target="#collapse-reminder-{{$type}}"
        ...
        <div id="collapse-reminder-{{$type}}" class="collapse" aria-labelledby="heading-reminder-{{$type}}"
             data-parent="#notification-reminder-{{$type}}">
            @if ($notifications->total())
