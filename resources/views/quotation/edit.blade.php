                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" name="supplier_id_hidden"
                                                       value="{{ $lims_quotation_data->supplier_id }}"/>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select required id="customer_id" name="customer_id"
                                                        ...
                                                        id="customer-id" data-live-search-style="begins"
                                                    ...
                                                    @foreach($lims_product_quotation_data as $product_quotation)
                                                        <tr>
                                                            ...
                                                            <td><input type="number" class="form-control qty"
                                                                       name="qty[]" value="{{$product_quotation->qty}}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" name="quotation_status_hidden"
                                                       value="{{$lims_quotation_data->quotation_status}}">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea rows="5" class="form-control"
                                                          name="note">{{ $lims_quotation_data->note }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
