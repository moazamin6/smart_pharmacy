        ...
        <div class="table-responsive">
            <table class="table table-flush table-hover">
                ...
                <tr class="row table-head-line">
                    ...
                    <th class="col-xs-4 col-sm-3 col-md-4 col-lg-4">@sortablelink('display_name', trans('general.name'),
                    ...
                    <th class="col-lg-3 d-none d-lg-block">@sortablelink('description', trans('general.description'))
                    </th>
                ...
                @foreach($roles as $item)
                    <tr class="row align-items-center border-top-1">
                        ...
                        <td class="col-xs-4 col-sm-3 col-md-4 col-lg-4"><a class="col-aka"
                                                                           href="{{ route('roles.edit', $item->id) }}">{{ $item->display_name }}</a>
                        </td>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                    <a class="dropdown-item"
                                       href="{{ route('roles.edit', $item->id) }}">{{ trans('general.edit') }}</a>
