        ...
        <div class="table-responsive">
            <table class="table table-flush table-hover">
                ...
                <tr class="row table-head-line">
                    ...
                    <th class="col-xs-4 col-sm-4 col-md-4 col-lg-4">@sortablelink('display_name', trans('general.name'),
                        ['filter' => 'active, visible'], ['class' => 'col-aka', 'rel' => 'nofollow'])
                    </th>
                    <th class="col-xs-4 col-sm-4 col-md-3 col-lg-3 long-texts">@sortablelink('name',
                        trans('general.code'))
                    </th>
                    <th class="col-md-2 col-lg-3 d-none d-md-block long-texts">@sortablelink('description',
                ...
                @foreach($permissions as $item)
                    <tr class="row align-items-center border-top-1">
                        ...
                        <td class="col-xs-4 col-sm-4 col-md-4 col-lg-4"><a class="col-aka"
                                                                           href="{{ route('permissions.edit', $item->id) }}">{{ $item->display_name }}</a>
                        </td>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                    <a class="dropdown-item"
                                       href="{{ route('permissions.edit', $item->id) }}">{{ trans('general.edit') }}</a>
