                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" name="status_hidden"
                                                       value="{{ $lims_transfer_data->status }}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" name="from_warehouse_id_hidden"
                                                       value="{{ $lims_transfer_data->from_warehouse_id }}"/>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" name="to_warehouse_id_hidden"
                                                       value="{{ $lims_transfer_data->to_warehouse_id }}"/>
                                                    ...
                                                    @foreach($lims_product_transfer_data as $product_transfer)
                                                        <tr>
                                                            ...
                                                            <td><input type="number" class="form-control qty"
                                                                       name="qty[]" value="{{$product_transfer->qty}}"
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <input type="hidden" name="total_qty"
                                                       value="{{$lims_transfer_data->total_qty}}"/>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <input type="hidden" name="total_tax"
                                                       value="{{$lims_transfer_data->total_tax}}"/>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <input type="hidden" name="total_cost"
                                                       value="{{$lims_transfer_data->total_cost}}"/>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <input type="hidden" name="grand_total"
                                                       value="{{$lims_transfer_data->grand_total}}"/>
                                                <input type="hidden" name="paid_amount"
                                                       value="{{$lims_transfer_data->paid_amount}}"/>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="shipping_cost" class="form-control"
                                                       value="{{ $lims_transfer_data->shipping_cost }}" step="any"/>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea rows="5" class="form-control"
                                                          name="note">{{ $lims_transfer_data->note }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
