    ...
    <section>
        <div class="container-fluid">
            <button class="btn btn-info" data-toggle="modal" data-target="#createModal"><i
                    class="dripicons-plus"></i> {{trans('file.Add Payroll')}} </button>
        </div>
                                ...
                                <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                    <li>
                                        <button type="button" data-id="{{$payroll->id}}"
                                                ...
                                                data-amount="{{$payroll->amount}}" data-note="{{$payroll->note}}"
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group">
                            ...
                            <select class="form-control selectpicker" name="employee_id" required
