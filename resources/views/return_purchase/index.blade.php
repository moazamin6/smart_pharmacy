    ...
    <section>
        <div class="container-fluid">
            @if(in_array("purchase-return-add", $all_permission))
                <a href="{{route('return-purchase.create')}}" class="btn btn-info"><i
                        class="dripicons-plus"></i> {{trans('file.Add Return')}}</a>
            @endif
        </div>
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                    ...
                                    @if(in_array("purchase-return-edit", $all_permission))
                                        <li>
                                            <a href="{{ route('return-purchase.edit', $return->id) }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 d-print-none">
                                <button type="button" id="close-btn" data-dismiss="modal" aria-label="Close"
                                        class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span>
                                </button>
                            </div>
                            <div class="col-md-12">
