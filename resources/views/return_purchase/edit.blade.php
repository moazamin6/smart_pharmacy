                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" name="supplier_id_hidden"
                                                       value="{{$lims_return_data->supplier_id}}">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select required id="account_id" name="account_id"
                                                        class="selectpicker form-control" data-live-search="true"
                                                        data-live-search-style="begins" title="Select account...">
                                                    ...
                                                    @foreach($lims_product_return_data as $product_return)
                                                        <tr>
                                                            ...
                                                            <input type="hidden" class="net_unit_cost"
                                                                   name="net_unit_cost[]"
                                                                   value="{{$product_return->net_unit_cost}}"/>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <input type="hidden" name="total_cost"
                                                       value="{{$lims_return_data->total_cost}}"/>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea rows="5" class="form-control"
                                                          name="return_note">{{$lims_return_data->return_note}}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea rows="5" class="form-control"
                                                          name="staff_note">{{$lims_return_data->staff_note}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
