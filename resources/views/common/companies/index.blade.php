        ...
        <div class="table-responsive">
            <table class="table table-flush table-hover">
                ...
                <tr class="row table-head-line">
                    ...
                    <th class="col-sm-2 col-md-2 col-lg-1 col-xl-1 d-none d-sm-block">@sortablelink('id',
                        trans('general.id'), ['filter' => 'active, visible'], ['class' => 'col-aka', 'rel' =>
                        'nofollow'])
                    </th>
                    <th class="col-xs-4 col-sm-3 col-md-2 col-lg-3 col-xl-3 long-texts">@sortablelink('name',
                        trans('general.name'))
                    </th>
                    <th class="col-md-2 col-lg-2 col-xl-2 d-none d-md-block long-texts">@sortablelink('email',
                        trans('general.email'))
                    </th>
                    <th class="col-lg-2 col-xl-2 d-none d-lg-block">@sortablelink('created_at',
                        trans('general.created'))
                    </th>
                    <th class="col-xs-4 col-sm-3 col-md-2 col-lg-2 col-xl-2">@sortablelink('enabled',
                ...
                @foreach($companies as $item)
                    <tr class="row align-items-center border-top-1">
                        ...
                        <td class="col-sm-2 col-md-2 col-lg-1 col-xl-1 d-none d-sm-block"><a
                                class="col-aka">{{ $item->id }}</a></td>
                        <td class="col-xs-4 col-sm-3 col-md-2 col-lg-3 col-xl-3 long-texts"><a
                                href="{{ route('companies.edit', $item->id) }}">{{ $item->name }}</a></td>
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                    @if ($item->enabled)
                                        <a class="dropdown-item"
                                           href="{{ route('companies.switch', $item->id) }}">{{ trans('general.switch') }}</a>
                                        <div class="dropdown-divider"></div>
                                    @endif
                                    <a class="dropdown-item"
                                       href="{{ route('companies.edit', $item->id) }}">{{ trans('general.edit') }}</a>
