        ...
        <div class="table-responsive">
            <table class="table table-flush table-hover">
                ...
                <tr class="row table-head-line">
                    ...
                    <th class="col-xs-4 col-sm-3 col-md-6 col-lg-7 col-xl-7 long-texts">@sortablelink('name',
                        trans('general.name'))
                    </th>
                ...
                @foreach($dashboards as $item)
                    <tr class="row align-items-center border-top-1">
                        ...
                        <td class="col-xs-4 col-sm-3 col-md-6 col-lg-7 col-xl-7 long-texts"><a
                                href="{{ route('dashboards.edit', $item->id) }}">{{ $item->name }}</a></td>
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                    @if ($item->enabled)
                                        <a class="dropdown-item"
                                           href="{{ route('dashboards.switch', $item->id) }}">{{ trans('general.switch') }}</a>
                                        <div class="dropdown-divider"></div>
                                    @endif
                                    <a class="dropdown-item"
                                       href="{{ route('dashboards.edit', $item->id) }}">{{ trans('general.edit') }}</a>
