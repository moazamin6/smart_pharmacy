        ...
        <div class="table-responsive">
            <table class="table table-flush table-hover">
                ...
                @foreach($transactions as $item)
                    <tr class="row align-items-center border-top-1">
                        ...
                        @if ($item->isIncome())
                            <td class="col-xs-4 col-sm-3 col-md-2 text-right">@money($item->amount,
                        ...
                        <td class="col-md-1 text-right d-none d-md-block">
                            <div class="custom-control custom-checkbox">
                                ...
                                <label class="custom-control-label"
                                       for="transaction-{{ $item->id . '-'. $type }}"></label>
                            </div>
                        </td>
                    </tr>
                @endforeach
            ...
            @if ($transactions->count())
                <table class="table">
                    <tbody>
                    <tr class="row">
                        <th class="col-md-9 col-lg-11 text-right d-none d-md-block">{{ trans('reconciliations.opening_balance') }}
                            :
                        </th>
                    ...
                    <tr class="row">
                        <th class="col-md-9 col-lg-11 text-right d-none d-md-block">{{ trans('reconciliations.closing_balance') }}
                            :
                        </th>
                    ...
                    <tr class="row">
                        <th class="col-md-9 col-lg-11 text-right d-none d-md-block">{{ trans('reconciliations.cleared_amount') }}
                            :
                        </th>
                    ...
                    <tr :class="difference" class="row">
                        <th class="col-md-9 col-lg-11 text-right d-none d-md-block">{{ trans('general.difference') }}:
                        </th>
                        ...
                        @if ($transactions->count())
                            <div class="float-right">
                                <a href="{{ route('reconciliations.index') }}"
                                   class="btn btn-outline-secondary">{{ trans('general.cancel') }}</a>
