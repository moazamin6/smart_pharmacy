...
@section('new_button')
    ...
    @endcan
    <a href="{{ route('import.create', ['banking', 'transactions']) }}"
       class="btn btn-white btn-sm">{{ trans('import.import') }}</a>
    <a href="{{ route('transactions.export', request()->input()) }}"
        ...
        <div class="table-responsive">
            <table class="table table-flush table-hover">
                ...
                <tr class="row table-head-line">
                    ...
                    <th class="col-md-2 col-lg-1 col-xl-1 d-none d-md-block text-left">@sortablelink('type',
                    ...
                    <th class="col-xs-4 col-sm-2 col-md-2 col-lg-3 col-xl-3 d-none d-md-block">
