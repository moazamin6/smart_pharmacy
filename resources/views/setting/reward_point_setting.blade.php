                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>{{trans('file.Sold amount per point')}} *</label> <i
                                            class="dripicons-question" data-toggle="tooltip"
                                            title="{{trans('file.This means how much point customer will get according to sold amount. For example, if you put 100 then for every 100 dollar spent customer will get one point as reward.')}}"></i>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>{{trans('file.Minumum sold amount to get point')}} * <i
                                                class="dripicons-question" data-toggle="tooltip"
                                                title="{{trans('file.For example, if you put 100 then customer will only get point after spending 100 dollar or more.')}}"></i></label>
