                            ...
                            <div class="mt-3">
                                ...
                                @if (!$hideButtonEdit)
                                    @can($permissionUpdate)
                                        <a href="{{ route($routeButtonEdit, $document->id) }}"
                            ...
                            @if ($document->status != 'sent' && $document->status != 'partial' && $document->status != 'viewed' && $document->status != 'received')
                                ...
                                <div class="mt-3">
                                    ...
                                    @if (!$hideButtonReceived)
                                        @can($permissionUpdate)
                                            @if ($document->status == 'draft')
                                                <a href="{{ route($routeButtonReceived, $document->id) }}"
                                                   class="btn btn-danger btn-sm btn-alone header-button-top"
                                                   @click="e => e.target.classList.add('disabled')">
                                        ...
                                        <div class="mt-3">
                                            ...
                                            @if (!$hideButtonEmail)
                                                @if($document->contact_email)
                                                    <a href="{{ route($routeButtonEmail, $document->id) }}"
                                                ...
                                                @else
                                                    <el-tooltip
                                                        content="{{ trans('invoices.messages.email_required') }}"
                                                        placement="top">
                                                        <button type="button"
                                                                class="btn btn-danger btn-sm btn-tooltip disabled header-button-top">
                                                            {{ trans($textTimelineSendStatusMail) }}
                                                        </button>
                                                    </el-tooltip>
                                                @endif
                            ...
                            <span class="timeline-step badge-success">
                                ...
                                <div class="timeline-content">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        @if (!$hideButtonPaid)
                                            @can($permissionUpdate)
                                                <a href="{{ route($routeButtonPaid, $document->id) }}"
                                                   class="btn btn-white btn-sm header-button-top"
                                                   @click="e => e.target.classList.add('disabled')">
