...
@section('new_button')
    @can('create-sales-customers')
        ...
        <a href="{{ route('import.create', ['group' => 'sales', 'type' => 'customers']) }}"
           class="btn btn-white btn-sm">{{ trans('import.import') }}</a>
    @endcan
    <a href="{{ route('customers.export', request()->input()) }}"
                        ...
                        <tr class="row align-items-center border-top-1">
                            ...
                            <td class="col-xs-4 col-sm-3 col-md-4 col-lg-3 col-xl-3">
                                <a class="col-aka long-texts d-block"
                                   href="{{ route('customers.show', $item->id) }}">{{ $item->name }}</a>
                            </td>
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                        ...
                                        @can('create-sales-customers')
                                            <a class="dropdown-item"
                                               href="{{ route('customers.duplicate', $item->id) }}">
