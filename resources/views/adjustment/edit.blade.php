                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" name="warehouse_id_hidden"
                                                       value="{{$lims_adjustment_data->warehouse_id}}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                    ...
                                                    @foreach($lims_product_adjustment_data as $product_adjustment_data)
                                                        <tr>
                                                            ...
                                                            <td><input type="number" class="form-control qty"
                                                                       name="qty[]"
                                                                       value="{{$product_adjustment_data->qty}}"
                                                                       required step="any"/></td>
                                                            <td class="action">
                                                                <select name="action[]" class="form-control act-val">
                                                                    @if($product_adjustment_data->action == '+')
                                                                        <option
                                                                            value="+">{{trans("file.Addition")}}</option>
                                                                        <option
                                                                            value="-">{{trans("file.Subtraction")}}</option>
                                                                    @else
                                                                        <option
                                                                            value="-">{{trans("file.Subtraction")}}</option>
                                                                        <option
                                                            ...
                                                            <td>
                                                                ...
                                                                <input type="hidden" name="product_code[]"
                                                                       class="product-code" value="{{$product->code}}"/>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea rows="5" class="form-control"
                                                          name="note">{{$lims_adjustment_data->note}}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
