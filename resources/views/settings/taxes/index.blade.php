            ...
            <div class="table-responsive">
                <table class="table table-flush table-hover">
                    ...
                    <tr class="row table-head-line">
                        ...
                        <th class="col-md-2 col-lg-2 d-none d-md-block">@sortablelink('rate',
                        ...
                        <th class="col-xs-4 col-sm-3 col-md-2 col-lg-2">@sortablelink('enabled',
                    ...
                    @foreach($taxes as $item)
                        <tr class="row align-items-center border-top-1">
                            ...
                            <td class="col-xs-4 col-sm-3 col-md-2 col-lg-4"><a class="col-aka"
                                                                               href="{{ route('taxes.edit', $item->id) }}">{{ $item->name }}</a>
                            </td>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                        <a class="dropdown-item"
                                           href="{{ route('taxes.edit', $item->id) }}">{{ trans('general.edit') }}</a>
