@extends('layout.main') @section('content')
    ...
    @if($errors->has('rate'))
        <div class="alert alert-danger alert-dismissible text-center">
            <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span
                    aria-hidden="true">&times;</span></button>{{ $errors->first('rate') }}</div>
    @endif
    ...
    <section>
        <div class="container-fluid">
            <a href="#" data-toggle="modal" data-target="#createModal" class="btn btn-info"><i
                    class="dripicons-plus"></i> {{trans('file.Add Tax')}}</a>
            <a href="#" data-toggle="modal" data-target="#importTax" class="btn btn-primary"><i
                    class="dripicons-copy"></i> {{trans('file.Import Tax')}}</a>
        </div>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                    <li>
                                        <button type="button" data-id="{{$tax->id}}"
                                                class="open-EdittaxDialog btn btn-link" data-toggle="modal"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p>{{trans('file.The correct column order is')}} (name*,
                        rate*) {{trans('file.and you must follow this')}}.</p>
